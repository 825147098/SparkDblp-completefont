...
(function ($) {
    $.fn.polygonizr = function (options) {
        var defaults = {
            ...
            animationFps: 30,
            // Sets the color of the node dots in the network (RGB).节点颜色
            nodeDotColor: "240, 255, 250",
            // Sets the color of the node lines in the network (RGB).节点线颜色
            nodeLineColor: "240, 255, 250",
            // Sets the color of the filled triangles in the network (RGB).镜片颜色
